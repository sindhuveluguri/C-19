...
public class PatientDetailsActivity extends AppCompatActivity {
    ...
    private Button bt_diet, btn_cases,bt_search,bt_consult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_consult = findViewById(R.id.bt_consult);
        ...
        bt_consult.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PatientDetailsActivity.this,ConsultActivity.class));
            }
        });
